...
from robodriver.robots.utils import Robot
from robodriver.utils.constants import DOROBOT_DATASET
from robodriver.utils.dataset import (
    DEFAULT_AUDIO_PATH,
    DEFAULT_FEATURES,
    DEFAULT_IMAGE_PATH,
...
from robodriver.utils.video import (
...
class DoRobotDatasetMetadata:
    ...
    def _version(self) -> packaging.version.Version:
        ...
        return packaging.version.parse(self.info["dorobot_dataset_version"])
